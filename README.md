...
A pesar de cambiar el intevalo de generación exponential por (0.15) o (0.175) se obtiene exactamente el mismo resultado que en el primer intervalo. Esto se puede observar en la siguiente ilustración.
...
A pesar de que los casos coinciden en la mayoría de los datos, los siguientes gráficos representan el delay de los paquetes en el caso (0.1) y el (0.175). En el primer caso se puede observar como el crecimiento es casi constante con algúnas pequeñas variaciones en donde el valor máximo alcanzado es casi 60, mientras que en el segundo caso si bien el delay se va incrementando lo hace der forma irregular y el valor máximo alcanzaso es algo menor a 30.
